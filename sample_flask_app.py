...
def photo_titles(tag, num):
    ...
    FLICKR_KEY = "803aa0d72de6877894157b0d5c1aa9ad" # TODO: fill in a flickr key
    ...
    return render_template('photo_info.html',num=num, photo_titles= title_list)
